...
'+Fascinating. _(Lieutenant Spock)_+'
...
GReP is funded by https://www.merigen.it/[Merigen Research s.r.l] and POR Campania FSE 2014-2020 ASSE III – Ob. Sp. 14

image::images/loghi_grep.png[loghi_grep,400,align="left"]


image:images/Octicons-mark-github.svg[git,30] GReP code is on https://github.com/ezcn/grep
...
image:images/Octicons-mark-github.svg[git,30] vgpop code is on https://github.com/Flavia95/VGpop[image:images/Octicons-mark-github.svg]
...
image::images/bloccscheme.png[B,600,500]

[.left]
image::images/blok-large.png[A,300]
