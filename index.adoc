...
:hardbreaks-option:
We leverage innovative genomic technologies to uncover genetic factors influencing reproductive outcomes and pregnancy complications. The results can enable better screening, diagnosis, and treatment approaches for couples struggling with infertility, miscarriage, and preeclampsia. The results will help improve preimplantation genetic testing for IVF and provide insights into mechanisms of embryo arrest and miscarriage.  The results can improve genetic screening for couples planning pregnancy.
